...
- [X] **T_SETUP_002**: DDLスクリプトの作成
  ...
  - **参照SPEC**: data_model.md の全テーブル定義（PUBLISHER、CATEGORY、BOOK、STOCK、CUSTOMER、ORDER_TRAN、ORDER_DETAIL）
...
- [X] **T_SETUP_003**: 初期データスクリプトの作成
  ...
  - **参照SPEC**: data_model.md のサンプルデータ（PUBLISHER、CATEGORY、BOOK、STOCK、CUSTOMER）
...
- [ ] **T_SETUP_004**: HSQLDBサーバーの起動と初期化
  ...
  - **参照SPEC**: architecture_design.md のデータベース構成
...
- [X] **T_SETUP_005**: persistence.xmlの作成
  ...
  - **参照SPEC**: architecture_design.md の永続化構成
...
- [X] **T_SETUP_006**: web.xmlの作成
  ...
  - **参照SPEC**: architecture_design.md のデプロイ構成
...
- [X] **T_SETUP_007**: faces-config.xmlの作成
  ...
  - **参照SPEC**: architecture_design.md のアーキテクチャ設計
...
- [ ] **T_SETUP_010**: JDBCコネクションプールの設定
  ...
  - **参照SPEC**: architecture_design.md のコネクションプール
...
- [X] **T_SETUP_012**: CSSファイルの作成
  ...
  - **参照SPEC**: screen_design.md のカラースキーム
...
- [X] **T_SETUP_013**: 書籍カバー画像のコピー
  ...
  - **参照SPEC**: data_model.md のカバー画像の取り扱い
