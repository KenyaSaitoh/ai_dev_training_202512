# berry-books-frontend-vibe プロジェクト（研修用）
...
```bash
# 1. プロジェクトのディレクトリに移動
cd projects/react/berry-books-frontend-vibe
...
```
projects/react/berry-books-frontend-vibe/
├── src/
│   ├── components/
...
```bash
# berry-books-frontend-vibeディレクトリで実行
cd projects/react/berry-books-frontend-vibe
npm install  # 初回のみ
npm run dev
```
